...
export default function UserInspectPage() {
  ...
  return (
    <div className="h-screen bg-slate-50 dark:bg-slate-950 flex flex-col overflow-hidden relative">
      <header className="sticky top-0 z-[100] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b dark:border-white/5 h-16 md:h-20 flex items-center px-4 md:px-10 justify-between shrink-0 shadow-sm">
      ...
      <main className="flex-1 overflow-y-auto scrollbar-hide p-4 md:p-8 lg:p-10">
                            ...
                            <div className="p-3 sm:p-5 rounded-2xl bg-slate-50 dark:bg-slate-800 border dark:border-white/5 flex justify-between items-center gap-3">
                              ...
                              <div className="flex items-center gap-2">
                                {targetUser.suspendedUntil && targetUser.suspendedUntil > Date.now() ? (
                                  <Badge className="bg-red-50 text-red-500 border-none uppercase font-black text-[8px] h-5">SUSPENDED</Badge>
                                ) : (
