      ...
      <section className="flex flex-col items-center text-center">
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="flex items-center justify-center gap-1 min-w-0">
            <h2 className="truncate font-headline font-bold text-2xl sm:text-4xl lg:text-7xl text-slate-900 dark:text-white tracking-tight max-w-[280px] sm:max-w-none">{user.name}</h2>
